...
func main() {
	...
	bow.Open("https://albatrosair.aero/reservas/busqueda.php?location_origin=CCS&location_destination=SJO" +
		"&time_depart=2018-04-09&time_return=2018-04-16&pax_CNN=0&pax_ADT=1&pax_INF=0&is_roundtrip=1")

	bow.Open("https://albatrosair.aero/reservas/ajaxbuscar2.php?acc=buscar&is_roundtrip=1&location_origin=CCS" +
		"&location_destination=SJO&time_depart=2018-04-09&time_return=2018-04-16&pax_ADT=1&pax_CNN=0&pax_INF=0&flexible=&cabin_type=")
