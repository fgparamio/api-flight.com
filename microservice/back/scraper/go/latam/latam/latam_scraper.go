...
func main() {
	...
	err := bow.Open("http://booking.lan.com/es_co/apps/personas/compra?fecha1_dia=31&fecha1_anomes=2018-03&fecha2_dia=14" +
		"&fecha2_anomes=2018-04&from_city2=SCL&to_city2=BOG&auAvailability=1&ida_vuelta=ida_vuelta&vuelos_origen=Bogot%C3%A1" +
	...
	var jsonReq = []byte(`{"language":"ES","country":"CO","portal":"personas","application":"compra_normal","section":"step2",
		...
		"destination":"SCL","referenceFlight":{"departureDate":"2018-04-14","destination":"BOG","origin":"SCL"},"tripType":"outbound"}`)
